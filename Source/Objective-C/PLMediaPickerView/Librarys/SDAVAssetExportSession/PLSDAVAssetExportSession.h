//
//  PLSDAVAssetExportSession.h
//
// This file is part of the PLSDAVAssetExportSession package.
//
...
@protocol PLSDAVAssetExportSessionDelegate;


/**
 * An `PLSDAVAssetExportSession` object transcodes the contents of an AVAsset source object to create an output
...
@interface PLSDAVAssetExportSession : NSObject

@property (nonatomic, weak) id<PLSDAVAssetExportSessionDelegate> delegate;
...
@protocol PLSDAVAssetExportSessionDelegate <NSObject>

- (void)exportSession:(PLSDAVAssetExportSession *)exportSession renderFrame:(CVPixelBufferRef)pixelBuffer withPresentationTime:(CMTime)presentationTime toBuffer:(CVPixelBufferRef)renderBuffer;
