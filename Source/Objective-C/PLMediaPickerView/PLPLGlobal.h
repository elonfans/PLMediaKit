...
#define PLdispatch_main_async_safe(block)\
...
#define KOSNavigationBarAndStatusHeight 65
...
#define KOSDeviceScale MIN(KOSWidth/375.0f, 1.44)


#define PNGImage(name) [T imageNamed:[NSString stringWithFormat:@"%@.png",name]]

@interface PLPLGlobal : NSObject {
